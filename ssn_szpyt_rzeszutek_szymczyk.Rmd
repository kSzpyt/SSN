...
```
##Skuteczność.
(to przy pierwszym spr skuteczności po funkcji foo)
...
(zmiana liczby neuronow na dwóch warst)
Skuteczność waha się pomiędzy 76%, które jest najniższym wynikiem, a 92,1%. 
(3 warstwy)
